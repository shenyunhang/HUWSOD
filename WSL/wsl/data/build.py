...
from .dataset_mapper_weakstrong import DatasetMapperWeakStrong
...
def _train_loader_from_config(cfg, mapper=None, *, dataset=None, sampler=None):
    ...
    if mapper is None and cfg.WSL.DATA.WEAKSTRONG_ON:
        mapper = DatasetMapperWeakStrong(cfg, True)
    if mapper is None:
...
def _test_loader_from_config(cfg, dataset_name, mapper=None):
    ...
    if mapper is None and cfg.WSL.DATA.WEAKSTRONG_ON:
        mapper = DatasetMapperWeakStrong(cfg, False)
    if mapper is None:
