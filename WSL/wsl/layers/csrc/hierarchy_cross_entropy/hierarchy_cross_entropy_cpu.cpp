...
#include "hierarchy_cross_entropy.h"
...
template <typename T>
void HierarchyCrossEntropyForward(
    const T* input,
...
template <typename T>
void HierarchyCrossEntropyBackward(
    const T* grad_output,
...
std::tuple<at::Tensor, at::Tensor> hierarchy_cross_entropy_forward_cpu(
  ...
  at::CheckedFrom c = "hierarchy_cross_entropy_forward_cpu";
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      input.scalar_type(), "hierarchy_cross_entropy_forward", [&] {
        HierarchyCrossEntropyForward<scalar_t>(
...
at::Tensor hierarchy_cross_entropy_backward_cpu(
  ...
  at::CheckedFrom c = "hierarchy_cross_entropy_backward_cpu";
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      grad.scalar_type(), "hierarchy_cross_entropy_backward", [&] {
        HierarchyCrossEntropyBackward<scalar_t>(
