...
class WSDDNOutputLayers(nn.Module):
    ...
    def from_config(cls, cfg, input_shape):
        return {
            ...
            "loss_weight"               : {"loss_box_reg": cfg.MODEL.ROI_BOX_HEAD.BBOX_REG_LOSS_WEIGHT, "loss_cls": cfg.WSL.WSDDN.WEIGHT}, # noqa
            ...
            "mean_loss"                 : cfg.WSL.WSDDN.MEAN_LOSS,
            "cmil"                      : cfg.WSL.CMIL,
...
class CSCOutputs(object):
    ...
    def softmax_cross_entropy_loss(self):
        ...
        Deprecated
        """
        _log_classification_stats(self.pred_class_logits, self.gt_classes, prefix="fast_rcnn_csc")
